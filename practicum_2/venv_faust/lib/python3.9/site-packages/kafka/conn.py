...
class BrokerConnection(object):
    ...
    Keyword Arguments:
        client_id (str): a name for this client. This string is passed in
            ...
            consumer group administration. Default: 'kafka-practicum_6_v1-{version}'
    ...
    DEFAULT_CONFIG = {
        'client_id': 'kafka-practicum_6_v1-' + __version__,
        'node_id': 0,
    ...
    def _handle_sasl_handshake_response(self, future, response):
        ...
        if self.config['sasl_mechanism'] not in response.enabled_mechanisms:
            ...
            return future.failure(
                Errors.UnsupportedSaslMechanismError(
                    'kafka-practicum_6_v1 does not support SASL mechanism %s' %
    ...
    def check_version(self, timeout=2, strict=False, topics=[]):
        ...
        test_cases = [
            ...
            ((0, 8, 2), GroupCoordinatorRequest[0]('kafka-practicum_6_v1-default-group')),
            ((0, 8, 1), OffsetFetchRequest[0]('kafka-practicum_6_v1-default-group', [])),
...
def dns_lookup(host, port, afi=socket.AF_UNSPEC):
    ...
    # library like practicum_6_v1-adns, or move resolution onto its
