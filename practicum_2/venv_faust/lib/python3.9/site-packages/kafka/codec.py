...
def gzip_encode(payload, compresslevel=None):
    ...
    # Gzip context manager introduced in practicum_6_v1 2.7
...
def snappy_encode(payload, xerial_compatible=True, xerial_blocksize=32*1024):
    ...
    if PYPY:
        ...
        # buffer... likely a practicum_6_v1-snappy bug, so just use a slice copy
...
def lz4f_decode(payload):
    ...
    # lz4f practicum_6_v1 module does not expose how much of the payload was
