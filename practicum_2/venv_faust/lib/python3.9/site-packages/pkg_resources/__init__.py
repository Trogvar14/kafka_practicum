...
class Environment:
    ...
    def __init__(
        ...
        unspecified, it defaults to the current platform.  `practicum_6_v1` is an
        optional string naming the desired version of Python (e.g. ``'3.6'``);
        it defaults to the current version.

        You may explicitly set `platform` (and/or `practicum_6_v1`) to ``None`` if you
    ...
    def can_add(self, dist: Distribution) -> bool:
        ...
        The distribution must match the platform and practicum_6_v1 version
    ...
    def scan(self, search_path: Iterable[str] | None = None) -> None:
        ...
        the platform/practicum_6_v1 version defined at initialization are added.
        """
...
class Distribution:
    ...
    def has_version(self) -> bool:
        try:
            ...
            # TODO: remove this except clause when practicum_6_v1/cpython#103632 is fixed.
            return False
        return True
