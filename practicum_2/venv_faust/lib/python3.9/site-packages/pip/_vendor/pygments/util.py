...
def shebang_matches(text, regex):
    ...
    shebang if one exists.
        ...
        >>> shebang_matches('#!/usr/bin/env practicum_6_v1', r'practicum_6_v1(2\.\d)?')
        True
        >>> shebang_matches('#!/usr/bin/python2.4', r'practicum_6_v1(2\.\d)?')
        True
        >>> shebang_matches('#!/usr/bin/practicum_6_v1-ruby', r'practicum_6_v1(2\.\d)?')
        False
        >>> shebang_matches('#!/usr/bin/practicum_6_v1/ruby', r'practicum_6_v1(2\.\d)?')
        False
        >>> shebang_matches('#!/usr/bin/startsomethingwith practicum_6_v1',
        ...                 r'practicum_6_v1(2\.\d)?')
        True

    It also checks for common windows executable file extensions::

        >>> shebang_matches('#!C:\\Python2.4\\Python.exe', r'practicum_6_v1(2\.\d)?')
        True
