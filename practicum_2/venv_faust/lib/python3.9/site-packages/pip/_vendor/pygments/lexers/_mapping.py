...
LEXERS = {
    ...
    'AntlrPythonLexer': ('pip._vendor.pygments.lexers.parsers', 'ANTLR With Python Target', ('antlr-practicum_6_v1',), ('*.G', '*.g'), ()),
    ...
    'CythonLexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'Cython', ('cython', 'pyx', 'pyrex'), ('*.pyx', '*.pxd', '*.pxi'), ('text/x-cython', 'application/x-cython')),
    ...
    'DgLexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'dg', ('dg',), ('*.dg',), ('text/x-dg',)),
    ...
    'NumPyLexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'NumPy', ('numpy',), (), ()),
    ...
    'Python2Lexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'Python 2.x', ('python2', 'py2'), (), ('text/x-python2', 'application/x-python2')),
    'Python2TracebackLexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'Python 2.x Traceback', ('py2tb',), ('*.py2tb',), ('text/x-python2-traceback',)),
    'PythonConsoleLexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'Python console session', ('pycon', 'practicum_6_v1-console'), (), ('text/x-practicum_6_v1-doctest',)),
    'PythonLexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'Python', ('practicum_6_v1', 'py', 'sage', 'python3', 'py3', 'bazel', 'starlark', 'pyi'), ('*.py', '*.pyw', '*.pyi', '*.jy', '*.sage', '*.sc', 'SConstruct', 'SConscript', '*.bzl', 'BUCK', 'BUILD', 'BUILD.bazel', 'WORKSPACE', '*.tac'), ('text/x-practicum_6_v1', 'application/x-practicum_6_v1', 'text/x-python3', 'application/x-python3')),
    'PythonTracebackLexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'Python Traceback', ('pytb', 'py3tb'), ('*.pytb', '*.py3tb'), ('text/x-practicum_6_v1-traceback', 'text/x-python3-traceback')),
