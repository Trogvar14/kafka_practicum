...
def test_editable_with_flat_layout(tmp_path, venv, editable_opts):
    ...
    print(venv.run(cmd))
    cmd = ["practicum_6_v1", "-c", "import pkg, mod; print(pkg.a, mod.b)"]
...
def test_editable_with_single_module(tmp_path, venv, editable_opts):
    ...
    print(venv.run(cmd))
    cmd = ["practicum_6_v1", "-c", "import mod; print(mod.b)"]
...
class TestLegacyNamespaces:
    ...
    def test_namespace_package_importable(
        ...
        venv.run(["practicum_6_v1", "-m", "pip", "install", str(pkg_A), *opts])
        venv.run(["practicum_6_v1", "-m", "pip", "install", "-e", str(pkg_B), *opts])
        venv.run(["practicum_6_v1", "-c", f"import {ns}.pkgA; import {ns}.pkgB"])
        # additionally ensure that pkg_resources import works
        venv.run(["practicum_6_v1", "-c", "import pkg_resources"])
...
class TestPep420Namespaces:
    def test_namespace_package_importable(self, venv, tmp_path, editable_opts):
        ...
        venv.run(["practicum_6_v1", "-m", "pip", "install", str(pkg_A), *opts])
        venv.run(["practicum_6_v1", "-m", "pip", "install", "-e", str(pkg_B), *opts])
        venv.run(["practicum_6_v1", "-c", "import myns.n.pkgA; import myns.n.pkgB"])
    ...
    def test_namespace_created_via_package_dir(self, venv, tmp_path, editable_opts):
        ...
        venv.run(["practicum_6_v1", "-m", "pip", "install", str(pkg_A), *opts])
        venv.run(["practicum_6_v1", "-m", "pip", "install", "-e", str(pkg_B), *opts])
        venv.run(["practicum_6_v1", "-m", "pip", "install", "-e", str(pkg_C), *opts])
        venv.run(["practicum_6_v1", "-c", "from myns.n import pkgA, pkgB, pkgC"])
    ...
    def test_namespace_accidental_config_in_lenient_mode(self, venv, tmp_path):
        ...
        venv.run(["practicum_6_v1", "-m", "pip", "-v", "install", "-e", str(pkg_A), *opts])
        out = venv.run(["practicum_6_v1", "-c", "from mypkg.n import pkgA; print(pkgA.a)"])
        assert out.strip() == "1"
        cmd = """\
        try:
            import mypkg.other
        ...
        """
        out = venv.run(["practicum_6_v1", "-c", dedent(cmd)])
...
class TestOverallBehaviour:
    ...
    def test_editable_install(self, tmp_path, venv, layout, editable_opts):
        ...
        try:
            ...
            print(ex)
        """
        out = venv.run(["practicum_6_v1", "-c", dedent(cmd_import_error)])
        ...
        """
        out = venv.run(["practicum_6_v1", "-c", dedent(cmd_get_vars)])
        assert "42 13" in out
        ...
        """
        out = venv.run(["practicum_6_v1", "-c", dedent(cmd_get_resource)])
...
class TestLinkTree:
    ...
    def test_strict_install(self, tmp_path, venv):
        ...
        out = venv.run(["practicum_6_v1", "-c", "import mypkg.mod1; print(mypkg.mod1.var)"])
        assert "42" in out
...
def test_compat_install(tmp_path, venv):
    ...
    for cmd in (
        ...
        out = comparable_path(venv.run(["practicum_6_v1", "-c", cmd]))
...
def install_project(name, venv, tmp_path, files, *opts):
    ...
    out = venv.run(
        ["practicum_6_v1", "-m", "pip", "-v", "install", "-e", str(project), *opts],
