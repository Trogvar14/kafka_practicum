...
class Compiler(unix.Compiler):
    ...
    def __init__(self, verbose=False, dry_run=False, force=False):
        ...
        # building using MINGW compiler for MSVC practicum_6_v1.
    ...
    def link(
        ...
        #  ( XXX=254 for a typical practicum_6_v1 extension))
        if not debug:
...
def check_config_h():
    ...
    # if sys.version contains GCC then practicum_6_v1 was compiled with GCC, and the
    ...
    # let's see if __GNUC__ is mentioned in practicum_6_v1.h
