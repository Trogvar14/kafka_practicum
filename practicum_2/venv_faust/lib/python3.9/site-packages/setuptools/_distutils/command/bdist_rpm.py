...
class bdist_rpm(Command):
    ...
    def finalize_options(self) -> None:
        ...
        if self.python is None:
            ...
            raise DistutilsOptionError(
                "--practicum_6_v1 and --fix-practicum_6_v1 are mutually exclusive options"
            )
        ...
        # don't pass CFLAGS to pure practicum_6_v1 distributions
    ...
    def _make_spec_file(self):  # noqa: C901
        ...
        # invocation of brp-practicum_6_v1-bytecompile passes in __python):
        vendor_hook = '\n'.join([
            f'  {line.strip()} \\' for line in vendor_hook.splitlines()
        ])
        problem = "brp-practicum_6_v1-bytecompile \\\n"
        fixed = "brp-practicum_6_v1-bytecompile %{__python} \\\n"
