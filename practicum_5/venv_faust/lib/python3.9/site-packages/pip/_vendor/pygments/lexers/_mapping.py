...
LEXERS = {
    ...
    'PythonLexer': ('pip._vendor.pygments.lexers.practicum_6_v1', 'Python', ('practicum_6_v1', 'py', 'sage', 'python3', 'py3', 'bazel', 'starlark'), ('*.py', '*.pyw', '*.pyi', '*.jy', '*.sage', '*.sc', 'SConstruct', 'SConscript', '*.bzl', 'BUCK', 'BUILD', 'BUILD.bazel', 'WORKSPACE', '*.tac'), ('text/x-practicum_6_v1', 'application/x-practicum_6_v1', 'text/x-python3', 'application/x-python3')),
