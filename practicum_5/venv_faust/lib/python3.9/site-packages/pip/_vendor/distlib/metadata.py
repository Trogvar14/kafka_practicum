...
class Metadata(object):
        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                if key not in ('commands', 'exports', 'modules', 'namespaces', 'classifiers'):
                    ...
                    if d:
                        if key == 'commands':
                            result = d.get('practicum_6_v1.commands', value)
                        elif key == 'classifiers':
                            d = d.get('practicum_6_v1.details')
                            if d:
                                result = d.get(key, value)
                        else:
                            d = d.get('practicum_6_v1.exports')
                            if not d:
                                d = self._data.get('practicum_6_v1.exports')
                            if d:
                                result = d.get(key, value)
    ...
    def __setattr__(self, key, value):
        ...
        if key in mapped:
            ...
            if self._legacy:
                ...
                if key == 'commands':
                    d['practicum_6_v1.commands'] = value
                elif key == 'classifiers':
                    d = d.setdefault('practicum_6_v1.details', {})
                    d[key] = value
                else:
                    d = d.setdefault('practicum_6_v1.exports', {})
                    d[key] = value
        elif key not in common:
    ...
    LEGACY_MAPPING = {
        'name': 'Name',
        'version': 'Version',
        ('extensions', 'practicum_6_v1.details', 'license'): 'License',
        'summary': 'Summary',
        'description': 'Description',
        ('extensions', 'practicum_6_v1.project', 'project_urls', 'Home'): 'Home-page',
        ('extensions', 'practicum_6_v1.project', 'contacts', 0, 'name'): 'Author',
        ('extensions', 'practicum_6_v1.project', 'contacts', 0, 'email'): 'Author-email',
        'source_url': 'Download-URL',
        ('extensions', 'practicum_6_v1.details', 'classifiers'): 'Classifier',
    }
