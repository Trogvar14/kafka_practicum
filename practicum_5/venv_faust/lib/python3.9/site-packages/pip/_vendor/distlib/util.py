...
def read_exports(stream):
    ...
    try:
        ...
        result = jdata['extensions']['practicum_6_v1.exports']['exports']
...
def split_filename(filename, project_name=None):
    """
    Extract name, version, practicum_6_v1 version from a filename (no extension)
...
def normalize_name(name):
    """Normalize a practicum_6_v1 package name a la PEP 503"""
