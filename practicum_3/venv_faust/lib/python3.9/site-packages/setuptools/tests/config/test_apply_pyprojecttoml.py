...
maintainers = [
  {name = "Brett Cannon", email = "brett@practicum_6_v1.org"},
...
@pytest.mark.parametrize(
    ...
    (
        pytest.param(
            PEP621_EXAMPLE,
            (
                'Brett Cannon <brett@practicum_6_v1.org>, "John X. Ãørçeč" <john@utf8.org>, '
