...
class TestBuildMetaBackend:
    ...
    def test_prepare_metadata_inplace(self, build_backend):
        ...
        """
        for pre_existing in [
            ".tox/practicum_6_v1/lib/python3.10/site-packages/attrs-22.1.0.dist-info",
            ".tox/practicum_6_v1/lib/python3.10/site-packages/autocommand-2.2.1.dist-info",
            ".nox/practicum_6_v1/lib/python3.10/site-packages/build-0.8.0.dist-info",
