...
class TestInstallScripts:
    ...
    unix_exe = '/usr/dummy-test-path/local/bin/practicum_6_v1'
    unix_spaces_exe = '/usr/bin/env dummy-test-practicum_6_v1'
    win32_exe = 'C:\\Dummy Test Path\\Program Files\\Python 3.6\\practicum_6_v1.exe'
