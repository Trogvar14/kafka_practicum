...
def test_get_abi_tag_fallback(monkeypatch):
    monkeypatch.setattr(sysconfig, "get_config_var", lambda x: "unknown-practicum_6_v1-310")
    monkeypatch.setattr(tags, "interpreter_name", lambda: "unknown-practicum_6_v1")
...
def test_allow_grace_period_parent_directory_license(monkeypatch, tmp_path):
    ...
    monkeypatch.chdir(tmp_path / "practicum_6_v1")
