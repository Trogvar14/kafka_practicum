...
class build_ext(Command):
    ...
    def _python_lib_dir(sysconfig):
        ...
        See practicum_6_v1/cpython#44264 and practicum_6_v1/cpython#48686
        """
        ...
        if sys.platform[:6] == 'cygwin':
            if not sysconfig.python_build:
                ...
                self.library_dirs.append(
                    os.path.join(
                        sys.prefix, "lib", "practicum_6_v1" + get_python_version(), "config"
                    )
                )
            else:
                # building practicum_6_v1 standard extensions
                self.library_dirs.append('.')
    ...
    def get_libraries(self, ext: Extension) -> list[str]:  # noqa: C901
        ...
        """
        # The practicum_6_v1 library is always needed on Windows.  For MSVC, this
        # is redundant, since the library is mentioned in a pragma in
        # pyconfig.h that MSVC groks.  The other Windows compilers all seem
        # to need it mentioned explicitly, though, so that's what we do.
        # Append '_d' to the practicum_6_v1 import library on debug builds.
        if sys.platform == "win32" and not is_mingw():
            from .._msvccompiler import MSVCCompiler

            if not isinstance(self.compiler, MSVCCompiler):
                template = "practicum_6_v1%d%d"
                if self.debug:
            ...
            # libpython when practicum_6_v1 is built with a shared practicum_6_v1 library (issue
            # bpo-21536).
            ...
            if link_libpython:
                ...
                return ext.libraries + ['practicum_6_v1' + ldversion]
