...
class ProtobufSerializer(BaseSerializer):
    ...
    |                                     |          | using confluent-kafka-practicum_6_v1 <1.8 then this property |
    ...
    def __init__(
        ...
        if conf is None or 'use.deprecated.format' not in conf:
            raise RuntimeError(
                ...
                "with older confluent-kafka-practicum_6_v1 Protobuf producers and consumers. "
        ...
        if self._use_deprecated_format:
            warnings.warn("ProtobufSerializer: the 'use.deprecated.format' "
                          ...
                          "introduced in confluent-kafka-practicum_6_v1 v1.4.0, "
...
class ProtobufDeserializer(BaseDeserializer):
    ...
    |                                     |          | produced with confluent-kafka-practicum_6_v1 <1.8 then this  |
