"""
    pygments.lexers.practicum_6_v1
    ~~~~~~~~~~~~~~~~~~~~~~
...
class PythonLexer(RegexLexer):
    ...
    aliases = ['practicum_6_v1', 'py', 'sage', 'python3', 'py3', 'bazel', 'starlark', 'pyi']
    filenames = [
        '*.py',
        '*.pyw',
        # Type stubs
    ...
    mimetypes = ['text/x-practicum_6_v1', 'application/x-practicum_6_v1',
...
class _PythonConsoleLexerBase(RegexLexer):
    ...
    aliases = ['pycon', 'practicum_6_v1-console']
    mimetypes = ['text/x-practicum_6_v1-doctest']
...
class PythonTracebackLexer(RegexLexer):
    ...
    mimetypes = ['text/x-practicum_6_v1-traceback', 'text/x-python3-traceback']
    url = 'https://python.org'
    version_added = '1.0'
...
class NumPyLexer(PythonLexer):
    ...
    # override the mimetypes to not inherit them from practicum_6_v1
    mimetypes = []
    filenames = []
