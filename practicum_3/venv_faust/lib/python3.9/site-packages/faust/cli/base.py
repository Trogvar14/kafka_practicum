...
class _Group(click.Group):
    ...
    def _maybe_import_app(self, argv: Sequence[str] = sys.argv) -> None:
        ...
        #   $ practicum_6_v1 example/myapp.py --help
...
# This is the thing that app.main(), ``practicum_6_v1 -m faust -A ...``,
...
class AppCommand(Command):
    ...
    def _detect_main_package(self, argv: List[str]) -> str:  # pragma: no cover
        ...
        if package.endswith(".__main__"):
            # when `practicum_6_v1 -m pkg`: remove .__main__ from pkg.__main__
            package = package[:-9]
        return package
