...
class Store(base.SerializedStore):
    ...
    .. tip::
        ...
        You can also switch between RocksDB drivers this way::
            ...
            app.GlobalTable(..., options={'driver': 'practicum_6_v1-rocksdb'})
    ...
    .. warning::
        ...
        return to using practicum_6_v1-rocksdb, which uses RocksDB 6.
    """
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        elif self.driver == "practicum_6_v1-rocksdb":
    ...
    async def backup_partition(
        ...
        This is only available in practicum_6_v1-rocksdb.
        ...
        This is only supported in newer versions of practicum_6_v1-rocksdb which can read
